...
class Profile extends Component {
    ...
    /** Fetch user details from instagram graph endpoint */
    fectchUserName = () => {
    ...
    /** Open Edit modal when user clicks Edit icon */
    openEditModalHandler = () => {
        this.setState({ editModalIsopen: !this.state.editModalIsopen })
    }

    /** Close Edit modal when user clicks Edit icon */
    ...
    /** Update state variable 'fullName' as user enter details on the screen*/
    inputFullNameChangeHandler = (event) => {
        this.setState({ fullName: event.target.value })
    }

    /** Update user name on the user info section */
    updateHandler = () => {
    ...
    /**Increase/ decrease like count when a user clikes the like icon */
    favIconClickHandler = () => {
    ...
    /** Update 'Comment' state variable as user enters details on the screen */
    inputCommentChangeHandler = (e) => {
        this.setState({ comment: e.target.value });
    }

    /** Add comment on a particular image */
    addCommentHandler = () => {
    ...
    render() {
        ...
        return (
            <div>
                ...
                {/** Image section code starts here */}

                {/** Edit Modal section code starts here */}
